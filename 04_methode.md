...
### Le Unified Process (UP)
Le 2TUP s’inscrit dans la continuité du Unified Process. Il repose sur quatre principes majeurs :
- Un développement itératif et incrémental,
- Une approche orientée risques,
- Une modélisation UML comme base de communication,
- Un focus sur l’architecture logicielle.
